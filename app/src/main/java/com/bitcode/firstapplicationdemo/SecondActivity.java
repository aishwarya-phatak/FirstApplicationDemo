        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (usernameEditText.getText().toString()
                        .equals("bitcode") && passwordEditText.getText().toString().equals("bitcode@1234")){
                    Toast.makeText(SecondActivity.this,"Login Successful", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(SecondActivity.this, "Login Failed", Toast.LENGTH_LONG).show();
                }
            }
        });
